...
const GoogleButton = ({ onError, setLoading }) => {
    ...
    return (
        <button
            ...
            className="flex items-center justify-center gap-2 w-full border border-gray-300 rounded-lg p-2.5 text-gray-700 hover:bg-gray-50 transition-colors"
        >
